...
class DetectBlue:
    ...
    def run(
        ...
        output_path: Path to output the resulting image with
        annotated detections.
        return_mask: Option to return the mask (black and white version
        of colour detection).
        """
        ...
        # Show res to see the result of what is being filtered in the
        #  colour detection
...
class DetectRed:
    ...
    def run(
        ...
        output_path: Path to output the resulting image with
        annotated detections.
        return_mask: Option to return the mask (black and white
        ...
        # Show res to see the result of what is being filtered
        ...
        # Include the "return_mask" parameter if statement here,
        # similar to how it is implemented in DetectBlue
